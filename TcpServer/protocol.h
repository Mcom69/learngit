...
#define DIR_NOT_ALLOW_VISIT "this dir not allow visit"
...
#define RENAME_FILE_FAILURED "rename file failure"

#define UPLOAD_FILE_OK "upload file ok"
#define UPLOAD_FILE_FAILURED "upload file failure"
...
#define COMOM_ERROR "operate failed : system is busy"

/**
 * 枚举类型，表示MSG类型
 * @brief The ENUM_MSG_TYPE enum
 */
enum ENUM_MSG_TYPE
{
    ENUM_MSG_TYPE_MIN = 0,
    ...
    ENUM_MSG_TYPE_ADD_AGREE,                    //同意添加好友
    ENUM_MSG_TYPE_ADD_REFUSE,                   //不同意添加好友

    ENUM_MSG_TYPE_FLUSH_FRIEND_REQUEST,         //刷新好友请求
    ENUM_MSG_TYPE_FLUSH_FRIEND_RESPOND,         //添加好友回复
...
PDU *mkPDU(uint uiMsglen);  //根据实际情况申请内存空间
